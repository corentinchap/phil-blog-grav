...
/* plugins.html.twig */
class __TwigTemplate_2dbf1babbb3eedf7f12386d07678d9010b596cac543b3d1b06dd5527b0b67d57 extends Twig_Template
{
    ...
    {
        // line 3
        $context["plugin_slug"] = $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", []);
        // line 5
        if ((isset($context["plugin_slug"]) ? $context["plugin_slug"] : null)) {
            ...
            if ((isset($context["installing"]) ? $context["installing"] : null)) {
                ...
                // line 14
                $context["package"] = $this->getAttribute($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "plugins", [0 => true], "method"), $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", []), [], "array");
                // line 15
                if ( !(isset($context["package"]) ? $context["package"] : null)) {
                    // line 16
                    $context["package"] = $this->getAttribute($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "plugins", [0 => false], "method"), $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", []), [], "array");
                    // line 17
                    $context["installed"] = false;
                }
                // line 20
                $context["plugin"] = $this->getAttribute((isset($context["package"]) ? $context["package"] : null), "toArray", [], "method");
                // line 21
                $context["title"] = (($this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.PLUGIN") . ": ") . twig_escape_filter($this->env, $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "name", [])));
            }
        } else {
            // line 24
            $context["title"] = $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.PLUGINS");
        ...
        // line 27
        if (($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", []) || (isset($context["installing"]) ? $context["installing"] : null))) {
        }
        // line 1
    ...
    ";
            ...
            ";
                // line 57
                try {
                    $this->loadTemplate((("plugins/" . $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", [])) . "-buttons.html.twig"), "plugins.html.twig", 57)->display($context);
    ...
    ";
        // line 72
        if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "plugins", []), "admin", []), "notifications", []), "plugins", [])) {
            // line 73
...
{% endblock %}
", "plugins.html.twig", "C:\\Users\\Coco_\\Documents\\GitHub\\blog-phil\\user\\plugins\\admin\\themes\\grav\\templates\\plugins.html.twig");
    }
}
