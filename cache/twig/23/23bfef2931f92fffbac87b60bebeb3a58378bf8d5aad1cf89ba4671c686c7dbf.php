...
class __TwigTemplate_7a4c94ddb113d857a7c8058f01ea9443350a9bcc22296bbc9e7d18e260c22d0a extends Twig_Template
{
    ...
    {
        // line 1
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "plugins", []), "admin", []), "logo_text", [])) {
            // line 2
            echo "<h3>
\t<a href=\"";
            // line 3
...
\t\t";
            // line 4
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "plugins", []), "admin", []), "logo_text", []), "html", null, true);
            echo "
\t</a>
...
", "partials/logo.html.twig", "C:\\Users\\Coco_\\Documents\\GitHub\\blog-phil\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\logo.html.twig");
    }
}
