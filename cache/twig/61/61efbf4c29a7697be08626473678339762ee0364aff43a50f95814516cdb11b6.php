...
class __TwigTemplate_3a218996b6451eacc7d179f5f28a0cb80af6f7876361f4978a8b2e9e760ceda9 extends Twig_Template
{
    ...
    {
        // line 1
        $context["gpm"] = $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "gpm", [], "method");
        // line 2
        $context["installed"] = $this->getAttribute((isset($context["gpm"]) ? $context["gpm"] : null), "isPluginInstalled", [0 => $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", [])], "method");
        // line 3
        $context["isTestingRelease"] = $this->getAttribute((isset($context["gpm"]) ? $context["gpm"] : null), "isTestingRelease", [0 => $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "slug", [])], "method");
        // line 4
...
<div class=\"grav-update plugin\" data-gpm-plugin=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", []), "html", null, true);
        echo "\">
</div>
...
<h1>
    ";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "name", []));
        echo "
    ";
        // line 11
        if ($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "isTeamGrav", [0 => (isset($context["plugin"]) ? $context["plugin"] : null)], "method")) {
            // line 12
    ...
    ";
        ...
        // line 14
        echo "    ";
        if ($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "isPremiumProduct", [0 => (isset($context["plugin"]) ? $context["plugin"] : null)], "method")) {
            // line 15
    ...
    ";
        ...
        // line 17
        echo "    ";
        if ($this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "symlink", [])) {
            // line 18
    ...
    ";
        ...
        // line 22
        echo "    <small>";
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "version", [])) ? (("v" . twig_escape_filter($this->env, $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "version", [])))) : ("")), "html", null, true);
        echo "</small>
    ";
        // line 23
...
<div class=\"gpm-item-info\">
    <i class=\"gpm-item-icon fa fa-fw fa-";
        // line 26
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "icon", []), "html", null, true);
        echo "\"></i>
    ";
        // line 27
        $this->loadTemplate("partials/plugin-data.html.twig", "partials/plugins-details.html.twig", 27)->display(array_merge($context, ["plugin" => (isset($context["plugin"]) ? $context["plugin"] : null)]));
        // line 28
        echo "</div>
...
";
        ...
        if ((isset($context["installed"]) ? $context["installed"] : null)) {
            // line 31
            echo "    ";
            $context["data"] = $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "data", [0 => ("plugins/" . $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", []))], "method");
            // line 32
            echo "    ";
            $this->loadTemplate("partials/blueprints.html.twig", "partials/plugins-details.html.twig", 32)->display(array_merge($context, ["data" => (isset($context["data"]) ? $context["data"] : null), "blueprints" => $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "blueprints", [])]));
            // line 33
            echo "
    ";
            // line 34
            if ((($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "form", []), "fields", []), "enabled", []), "type", []) != "hidden") && ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "form", []), "fields", []), "tabs", []), "fields", []), "login", []), "fields", []), "enabled", []), "type", []) != "hidden"))) {
                // line 35
...
";
        ...
        ";
            // line 46
            if (($this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "premium", []) &&  !$this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "license", [0 => $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "slug", [])], "method"))) {
                // line 47
                echo "            ";
            ...
            ";
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "premium", []), "permalink", []), "html", null, true);
        ...
        ";
                ...
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "slug", []), "html", null, true);
...
";
        ...
        // line 61
        $this->loadTemplate("partials/modal-remove-package.html.twig", "partials/plugins-details.html.twig", 61)->display(array_merge($context, ["type" => "plugin", "package" => (isset($context["plugin"]) ? $context["plugin"] : null)]));
        // line 62
        $this->loadTemplate("partials/modal-reinstall-package.html.twig", "partials/plugins-details.html.twig", 62)->display(array_merge($context, ["type" => "plugin", "package" => (isset($context["plugin"]) ? $context["plugin"] : null)]));
    }
...
", "partials/plugins-details.html.twig", "C:\\Users\\Coco_\\Documents\\GitHub\\blog-phil\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\plugins-details.html.twig");
    }
}
