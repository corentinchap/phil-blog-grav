...
class __TwigTemplate_6d73049ccda0a524d7c1df945b88183ba8944b4134f5b65042b59f1a5ab01f1d extends Twig_Template
{
...
";
        // line 4
        if ($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "findFormFields", [0 => "file", 1 => $this->getAttribute((isset($context["blueprints"]) ? $context["blueprints"] : null), "fields", [])], "method")) {
            // line 5
            echo "    ";
...
<form id=\"";
    ...
    ";
        // line 18
        if ($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "extra", [])) {
            // line 19
            echo "    ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "extra", []));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
...
", "partials/blueprints.html.twig", "C:\\Users\\Coco_\\Documents\\GitHub\\blog-phil\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\blueprints.html.twig");
    }
}
