...
class __TwigTemplate_9f7b3adae1ffa8be7c38e297a47b368aaeed3658a8c2448572eabe191e1658be extends Twig_Template
{
...
<div id=\"admin-user-details\">
    <a href=\"";
        ...
        echo "/user/";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "user", []), "username", []));
        echo "\">
        ";
        // line 6
        ...
        <div class=\"admin-user-names\">
            <h4>";
        // line 9
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "user", []), "fullname", []));
        echo " ";
        if ($this->getAttribute($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "user", []), "twofa_enabled", [])) {
            echo "<span class=\"badge\">2FA</span>";
        }
        echo "</h4>
            <h5>";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "user", []), "title", []));
        echo "</h5>
        </div>
    </a>
</div>
...
", "partials/nav-user-details.html.twig", "C:\\Users\\Coco_\\Documents\\GitHub\\blog-phil\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\nav-user-details.html.twig");
    }
}
