...
class __TwigTemplate_34e036cc0ce68cc60e9fbea1b5ca83308f3908ffdc4593a25916bffd7dd90af5 extends Twig_Template
{
...
";
    ...
    public function block_input($context, array $blocks = [])
    {
        ...
        ";
        // line 20
        $context["permissions"] = $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "getPermissions", []);
        // line 21
        echo "        ";
        ...
        foreach ($context['_seq'] as $context["index_existing_permission"] => $context["value_existing_permission"]) {
            ...
            foreach ($context['_seq'] as $context["index_segment1"] => $context["value_segment1"]) {
                // line 23
                echo "                ";
                $context["permissions"] = twig_array_merge((isset($context["permissions"]) ? $context["permissions"] : null), [(($context["index_existing_permission"] . ".") . $context["index_segment1"]) => "boolean"]);
                // line 24
                echo "            ";
            }
        ...
        foreach ($context['_seq'] as $context["permission"] => $context["type"]) {
            ...
            // line 30
            echo "                ";
            $context["permission_value"] = $this->getAttribute($this->getAttribute((isset($context["value"]) ? $context["value"] : null), $this->getAttribute((isset($context["permission_segments"]) ? $context["permission_segments"] : null), 0, [], "array"), [], "array"), $this->getAttribute((isset($context["permission_segments"]) ? $context["permission_segments"] : null), 1, [], "array"), [], "array");
            // line 31
            echo "                ";
            if (twig_in_filter((isset($context["permission_value"]) ? $context["permission_value"] : null), [0 => "on", 1 => "true", 2 => 1])) {
                // line 32
                echo "                    ";
            ...
            foreach ($context['_seq'] as $context["value"] => $context["text"]) {
                // line 42
                echo "                        ";
                $context["translation"] = (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "twig", [], "any", false, true), "twig", [], "any", false, true), "filters", [], "any", false, true), "tu", [], "array", true, true)) ? ($this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter($context["text"])) : ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($context["text"])));
                // line 43
                echo "                        ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["text"]) {
                // line 47
                echo "                        ";
                $context["id"] = (((("toggle_" . $this->getAttribute((isset($context["field"]) ? $context["field"] : null), "name", [])) . ".") . $context["permission"]) . $context["key"]);
                // line 48
                echo "                        ";
                $context["translation"] = twig_trim_filter((($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "twig", [], "any", false, true), "twig", [], "any", false, true), "filters", [], "any", false, true), "tu", [], "array", true, true)) ? ($this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter($context["text"])) : ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($context["text"]))));
                // line 49
                echo "
                        <input type=\"radio\"
                            value=\"";
                ...
                echo "\"
                            name=\"";
                // line 53
                echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->fieldNameFilter(((((isset($context["scope"]) ? $context["scope"] : null) . $this->getAttribute((isset($context["field"]) ? $context["field"] : null), "name", [])) . ".") . $context["permission"])), "html", null, true);
                echo "\"
                            class=\"";
                // line 54
...
", "forms/fields/permissions/permissions.html.twig", "C:\\Users\\Coco_\\Documents\\GitHub\\blog-phil\\user\\plugins\\admin\\themes\\grav\\templates\\forms\\fields\\permissions\\permissions.html.twig");
    }
}
